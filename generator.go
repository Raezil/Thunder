...
func main() {
	...
	if *proto != "" {
		if err := runCommand("protoc",
			"-I", ".",
			"--go_out=./internal/services/generated",
			"--go_opt=paths=source_relative",
			"--go-grpc_out=./internal/services/generated",
			"--go-grpc_opt=paths=source_relative",
			"--grpc-gateway_out=./internal/services/generated",
			"--grpc-gateway_opt=paths=source_relative",
			"--rpc-impl_out=./internal/services",
			"--openapiv2_out=./internal/services",
